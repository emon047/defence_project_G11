...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    _buildHeroStreakCard(context, streakData['current']!,
                        streakData['highest']!),
                    ...
                    _buildSectionHeader(
                        context, "Recent Aura", const MemoryPage()),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child:
            const Icon(Icons.add_rounded, color: AppColors.spaceDark, size: 35),
      ),
    );
  }
  ...
  //Bento Tiles (The 6 buttons)
  Widget _bentoTile(BuildContext context, String title, String sub,
      IconData icon, Color bgColor, Color iconColor, Widget page) {
    return GestureDetector(
  ...
  //Section Header (Recent Aura + See All)
